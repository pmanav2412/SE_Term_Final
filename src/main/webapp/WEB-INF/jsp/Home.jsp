    ...
    <ul class="nav nav-tabs card-header-tabs">
      ...
      <li class="nav-item">
		...
		<div class="table-responsive">
				<h3 style="color:black; padding-left:40%"> Friends List</h3>
					<table class="table table-striped table-bordered" style="color:black">
						...
						<tbody>
							...
							<c:forEach var="man" items="${friends}">
								<tr>
								 <td>${man.name}</td> 
								<td><c:out value="${man.uid}" /></td>
								<td> <a href=/profileOfFriends?FriendID=${man.uid}>See Profile</a></td> 
